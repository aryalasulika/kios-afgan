            ...
            <ul class="space-y-2">
                ...
                <li>
                    <a href="{{ route('cashiers.index') }}"
                        class="flex items-center py-3 px-4 rounded hover:bg-gray-700 transition duration-200 {{ request()->routeIs('cashiers.*') ? 'bg-gray-700' : '' }}">
                        <svg class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <li>
                    <a href="{{ route('bon.index') }}"
                        class="flex items-center py-3 px-4 rounded hover:bg-gray-700 transition duration-200 {{ request()->routeIs('bon.*') ? 'bg-gray-700' : '' }}">
                        <svg class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
