...
@section('content')
    <div class="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
        ...
        <a href="{{ route('cashiers.create') }}" class="w-full sm:w-auto text-center bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded shadow transition">
            + Tambah Kasir
        </a>
    </div>
    ...
    <!-- Search -->
    <div class="mb-6">
        <form action="{{ route('cashiers.index') }}" method="GET" class="flex gap-2">
            ...
            @if(request('search'))
                <a href="{{ route('cashiers.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded shadow transition flex items-center">
                    Reset
                </a>
            @endif
        </form>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="p-4 flex gap-4 justify-center items-center">
                                ...
                                <div id="resetPinModal-{{ $cashier->id }}" class="fixed inset-0 bg-gray-900 bg-opacity-75 hidden items-center justify-center z-50 flex">
                                    <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-sm m-auto text-left whitespace-normal">
    ...
    <div class="mt-4 pb-10">
        {{ $cashiers->withQueryString()->links() }}
    </div>
@endsection
